...
ActiveRecord::Schema.define(:version => 20130504145640) do
  ...
  add_index "sessions", ["session_id"], :name => "index_crumpd_sessions_on_session_id"
  add_index "sessions", ["updated_at"], :name => "index_crumpd_sessions_on_updated_at"
